...
CUDA_COMPILER=$CONDA_PREFIX/bin/nvcc  # at submission, it was: /usr/local/cuda/bin/nvcc
CXX_COMPILER=/usr/bin/g++-7         # at submission, it was: /usr/bin/g++-4.8
CUDA_INCLUDE=  # $CONDA_PREFIX/include    # at submission, it was: /usr/local/cuda/include/
